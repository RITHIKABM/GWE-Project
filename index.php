...
<html lang="en">
  ...
  <!-- <div class="site-wrap"> -->
      ...
      <div class="container">
        <div class="row align-items-center justify-content-center text-center">
          ...
          <div class="col-md-8" data-aos="fade-up" data-aos-delay="400">
            ...
            <h1 class="text-white font-weight-light text-uppercase font-weight-bold" data-aos="fade-up">GREENWAY EXPORTS</h1>
    ...
    <div class="site-section bg-image overlay" style="background-image: url('images/food_bg1.jpg');" id="section-how-it-works">
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-md-6 col-lg-4 mb-5 mb-lg-0" data-aos="fade" data-aos-delay="200">
            <div class="how-it-work-item">
              ...
              <div class="how-it-work-body">
                <h2>Choose Product And Make An Order</h2>
                <p class="mb-5">Select the Type from which you want to order.</p>
                <p class="mb-5">Choose you favourite dress and place the order</p>
                <!-- <ul class="ul-check list-unstyled success">
                  <li class="text-white">Error minus sint nobis dolor</li>
                  <li class="text-white">Voluptatum porro expedita labore esse</li>
                  <li class="text-white">Voluptas unde sit pariatur earum</li>
          ...
          <div class="col-md-9">
            <div class="row">
              <div class="col-md-5 mr-auto">
                ...
                <p>We Have The Glory Begining in Export Business
