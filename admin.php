          ...
          <div class="col-12 col-md-8 d-none d-xl-block">
            <nav class="site-navigation position-relative text-right" role="navigation">
              ...
              <ul class="site-menu js-clone-nav mx-auto d-none d-lg-block">
                <li><a href="#section-add" class="nav-link" style="color: #212529 !important">Add Branch</a></li>
   <li><a href="reports.php" class="nav-link" style="color: #212529 !important">Report</a></li>
                ...
                while($row=($result->fetch_assoc())){
                    ...
                    '
                                        ...
                                        <div class="modal-footer">
                                            <a href="delete_restaurant_action.php?id='.$row['R_ID'].'" type="button" class="btn btn-primary text-white">Delete Branch</a>
        ...
        <div class="container">
            <div class="row mb-5">
                <div class="col-md-12 order-md-1" data-aos="fade-up">
                    ...
                    <h2 class="text-primary">ADD Branch</h2>
                </div>
