...
<html lang="en">
  ...
  <!-- <div class="site-wrap"> -->
    ...
    <div class="site-section" style="background-image: url(images/food_bg1.jpg); background-size: cover;" id="section-home">
      <div class="container">
        ...
        ?>
                <div class="container">
                    <div class="jumbotron" style="margin-top: 4rem">
                        <h1 style="color: rgb(77,77,77) !important">Your Shopping Cart</h1>
                        <p style="color: rgb(77,77,77) !important">Oops! We can't find any product here. Go back and <a href="restaurant.php?rid=<?php echo $_GET["rid"]; ?>">order now.</a></p>
